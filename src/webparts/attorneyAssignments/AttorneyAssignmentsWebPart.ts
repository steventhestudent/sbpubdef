...
import * as strings from 'AttorneyAssignmentsWebPartStrings';
import AttorneyAssignments from './components/AttorneyAssignments';
import { IAttorneyAssignmentsProps } from './components/IAttorneyAssignmentsProps';
...
export default class AttorneyAssignmentsWebPart extends BaseClientSideWebPart<IAttorneyAssignmentsWebPartProps> {
	...
	public render(): void {
		const element: React.ReactElement<IAttorneyAssignmentsProps> = React.createElement(
			AttorneyAssignments,
			{
