...
import { IUrgencyPortalProps, IPowerBiLinkConfig } from "./components/IUrgencyPortalProps";
...
export default class UrgencyPortalWebPart extends BaseClientSideWebPart<IUrgencyPortalWebPartProps> {
  public render(): void {
    const element: React.ReactElement<IUrgencyPortalProps> = React.createElement(UrgencyPortal, {
