...
import { IExpertWitnessDirectoryProps } from './components/IExpertWitnessDirectoryProps';
...
export default class ExpertWitnessDirectoryWebPart extends BaseClientSideWebPart<IExpertWitnessDirectoryWebPartProps> {
	...
	public render(): void {
		const element: React.ReactElement<IExpertWitnessDirectoryProps> = React.createElement(
			ExpertWitnessDirectory,
			{
