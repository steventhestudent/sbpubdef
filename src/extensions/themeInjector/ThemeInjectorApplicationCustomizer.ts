...
export default class ThemeInjectorApplicationCustomizer extends BaseApplicationCustomizer<{}> {
  public async onInit(): Promise<void> {
    ...
    */
    ...
    const stripInsertion: () => void = () => getCanvasComponent()?.parentNode!.insertBefore(DismissibleAnnouncementStrip(), getCanvasComponent());
    (function pollInsert() {if (!getCanvasComponent()) setTimeout(pollInsert, 333); else setTimeout(stripInsertion, 666);})();
